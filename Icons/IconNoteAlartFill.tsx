...
const IconNoteAlartFill = (props: IconBaseProps) => {
  return WithIconProps(props, ({ width, height, fill, className }) => {
    return (
      ...
      >
        <path
          d="M22 16C22 16.5523 22.4477 17 23 17C23.5523 17 24 16.5523 24 16C24 15.4477 23.5523 15 23 15C22.4477 15 22 15.4477 22 16ZM23 7C22.4477 7 22 7.44772 22 8V12C22 12.5523 22.4477 13 23 13C23.5523 13 24 12.5523 24 12V8C24 7.44772 23.5523 7 23 7Z"
        />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
...
export default IconNoteAlartFill;