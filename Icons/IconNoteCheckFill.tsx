...
const IconNoteCheckFill = (props: IconBaseProps) => {
    ...
    return (
      ...
      >
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M22.7451 16.249C23.1592 16.6631 23.1592 17.3345 22.7451 17.7486L19.2817 21.2121C18.8479 21.6459 18.1446 21.6459 17.7108 21.2121L15.7469 19.2483C15.3328 18.8341 15.3328 18.1628 15.7469 17.7486C16.161 17.3345 16.8324 17.3345 17.2465 17.7486L18.4962 18.9983L21.2455 16.249C21.6596 15.8349 22.331 15.8349 22.7451 16.249Z"
        />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
...
export default IconNoteCheckFill;